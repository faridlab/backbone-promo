//! Domain policy for LoyaltyPointEntry aggregate
//!
...
/// Domain policy for LoyaltyPointEntry — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<LoyaltyPointEntry>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type LoyaltyPointEntryDomainPolicy = PermitAllPolicy<LoyaltyPointEntry>;
