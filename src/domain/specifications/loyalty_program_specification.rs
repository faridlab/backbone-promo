//! Specifications for LoyaltyProgram aggregate
//!
...
// Each predicate implements `Specification<LoyaltyProgram>` and can be combined
...
//
// pub struct ActiveLoyaltyProgramSpec;
// impl Specification<LoyaltyProgram> for ActiveLoyaltyProgramSpec {
//     fn is_satisfied_by(&self, e: &LoyaltyProgram) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
