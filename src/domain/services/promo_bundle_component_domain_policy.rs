//! Domain policy for PromoBundleComponent aggregate
//!
...
/// Domain policy for PromoBundleComponent — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<PromoBundleComponent>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type PromoBundleComponentDomainPolicy = PermitAllPolicy<PromoBundleComponent>;
