//! Domain policy for LoyaltyOrderPoints aggregate
//!
...
/// Domain policy for LoyaltyOrderPoints — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<LoyaltyOrderPoints>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type LoyaltyOrderPointsDomainPolicy = PermitAllPolicy<LoyaltyOrderPoints>;
