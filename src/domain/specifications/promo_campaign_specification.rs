//! Specifications for PromoCampaign aggregate
//!
...
// Each predicate implements `Specification<PromoCampaign>` and can be combined
...
//
// pub struct ActivePromoCampaignSpec;
// impl Specification<PromoCampaign> for ActivePromoCampaignSpec {
//     fn is_satisfied_by(&self, e: &PromoCampaign) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
