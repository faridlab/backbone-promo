//! Specifications for CouponCode aggregate
//!
...
// Each predicate implements `Specification<CouponCode>` and can be combined
...
//
// pub struct ActiveCouponCodeSpec;
// impl Specification<CouponCode> for ActiveCouponCodeSpec {
//     fn is_satisfied_by(&self, e: &CouponCode) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
