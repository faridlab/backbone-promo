//! Specifications for ProviderPromo aggregate
//!
...
// Each predicate implements `Specification<ProviderPromo>` and can be combined
...
//
// pub struct ActiveProviderPromoSpec;
// impl Specification<ProviderPromo> for ActiveProviderPromoSpec {
//     fn is_satisfied_by(&self, e: &ProviderPromo) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
