//! Specifications for PricingRule aggregate
//!
...
// Each predicate implements `Specification<PricingRule>` and can be combined
...
//
// pub struct ActivePricingRuleSpec;
// impl Specification<PricingRule> for ActivePricingRuleSpec {
//     fn is_satisfied_by(&self, e: &PricingRule) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
