//! Specifications for CouponRedemption aggregate
//!
...
// Each predicate implements `Specification<CouponRedemption>` and can be combined
...
//
// pub struct ActiveCouponRedemptionSpec;
// impl Specification<CouponRedemption> for ActiveCouponRedemptionSpec {
//     fn is_satisfied_by(&self, e: &CouponRedemption) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
