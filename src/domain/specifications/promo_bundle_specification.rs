//! Specifications for PromoBundle aggregate
//!
...
// Each predicate implements `Specification<PromoBundle>` and can be combined
...
//
// pub struct ActivePromoBundleSpec;
// impl Specification<PromoBundle> for ActivePromoBundleSpec {
//     fn is_satisfied_by(&self, e: &PromoBundle) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
