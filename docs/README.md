...
This directory contains documentation for the promo bounded context module.
...
backbone schema generate promo --target docs

# Generate OpenAPI spec only
backbone schema generate promo --target openapi
```

## Module Overview

**Bounded Context:** promo

**Description:** Advertisements, promo campaigns, banners (extracted from bersihir)
