# Promo Integration Tests

Integration test framework for the promo bounded context module.
...
cargo test --package backbone-promo --test run_integration_tests -- --ignored --nocapture

# 3. Run specific test suites
cargo test --package backbone-promo --test run_integration_tests run_{{entity_name}}_api_tests -- --ignored --nocapture
```
...
cargo test --package backbone-promo --test integration_tests

# Run with verbose output
TEST_VERBOSE=1 cargo test --package backbone-promo --test run_integration_tests -- --ignored --nocapture
```
