//! Specifications for LoyaltyPointEntry aggregate
//!
...
// Each predicate implements `Specification<LoyaltyPointEntry>` and can be combined
...
//
// pub struct ActiveLoyaltyPointEntrySpec;
// impl Specification<LoyaltyPointEntry> for ActiveLoyaltyPointEntrySpec {
//     fn is_satisfied_by(&self, e: &LoyaltyPointEntry) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
